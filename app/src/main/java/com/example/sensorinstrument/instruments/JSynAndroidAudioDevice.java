...
public class JSynAndroidAudioDevice implements AudioDeviceManager {
    ...
    private static class AndroidAudioOutputStream extends AndroidAudioStream implements AudioDeviceOutputStream {
    ...
    private static class AndroidAudioInputStream extends AndroidAudioStream implements AudioDeviceInputStream {
